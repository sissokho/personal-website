    ...
    <header class="p-5 border-b border-slate-200">
        <div class="flex items-center max-w-7xl mx-auto">
            ...
            <nav class="ml-auto flex gap-10" x-data="{ open: false }">
                ...
                <button class="absolute top-5 right-5 text-white z-20" x-cloak x-show="open" x-transition
                ...
                <a href="https://github.com/sissokho" target="_blank"
                    class="text-slate-500 transition-colors hover:text-black">
